      ...
      <div className="p-6 space-y-6 bg-slate-900 text-foreground min-h-screen">
        ...
        <Card className="bg-slate-800 p-4">
          ...
          news.map((announcement) => (
            ...
            >
              <div className="flex flex-col md:flex-row gap-6 items-start rounded-xl p-6 bg-gradient-to-br from-slate-800/90 to-slate-900/90 border border-slate-700/50 shadow-lg transition-all duration-300 hover:shadow-blue-500/20 hover:border-blue-500/30">
                <div className="relative shrink-0 w-[60px] h-[60px] mx-auto md:mx-0">
            <Image
            ...
            <div className="flex flex-col md:flex-row justify-between items-start">
              ...
              <p className="text-muted-foreground text-sm whitespace-nowrap mt-2 md:mt-0 md:ml-4">
