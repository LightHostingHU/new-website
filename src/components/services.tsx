    ...
    return (
        <div className="bg-slate-900 min-h-screen">
            <div className="container mx-auto py-16">
                <h1 className="text-4xl font-bold mb-8 text-center text-blue-500">Szolgáltatások</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service) => (
                        <Card key={service.id} className="overflow-hidden backdrop-blur-sm bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-1">
                            ...
                            <CardContent className="p-6 space-y-4">
                                <div className="space-y-3">
                                    ...
                                    <div className="flex items-center p-3 rounded-lg bg-black/10 hover:bg-black/20 transition-colors">
                                        ...
                                        <span className="text-gray-200">RAM: {service.more_info ? JSON.parse(service.more_info)["Szerver ram"] : "N/A"} MB</span>
                                    </div>
                                    <div className="flex items-center p-3 rounded-lg bg-black/10 hover:bg-black/20 transition-colors">
