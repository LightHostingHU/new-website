/*
  ...
  - You are about to alter the column `vm_id` on the `service` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Int`.
